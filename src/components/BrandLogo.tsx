    ...
    <div className={`flex items-center gap-3 group select-none ${className}`}>
      ...
      >
        ...
        >
          ...
          <rect x="5" y="5" width="90" height="90" rx="18" stroke="#10b981" stroke-width="3" stroke-opacity="0.3" fill="none" />
          ...
          <polygon points="50,44 57,50 50,56 43,50" fill="url(#brandGoldAccent)" stroke="#ffffff" stroke-width="0.8" />
        </svg>
      </div>
